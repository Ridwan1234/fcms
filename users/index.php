...
session_start();
error_reporting(0);
include("includes/config.php"); // includes the database configuration file
if(isset($_POST['submit']))
{
$ret=mysqli_query($con,"SELECT * FROM users WHERE matric_no or card_id='".$_POST['username']."' and password='".md5($_POST['password'])."'"); // validationg the foem with matric number or card_id and password
...
$query=mysqli_query($con,"SELECT * FROM users WHERE card_id='$card_id' and matric_no='$matric_no'");
$num=mysqli_fetch_array($query);
if($num>0)
{
mysqli_query($con,"update users set password='$password' WHERE card_id='$card_id' and contactNo='$matric_no' ");
$msg="Password Changed Successfully";

}
else
{
$errormsg="Invalid card id or matric no";
}
}
?>
...
<input type="text" name="card_id" placeholder="Card Id" autocomplete="off" class="form-control" required><br >
<input type="text" name="matric_no" placeholder="Matric No" autocomplete="off" class="form-control" required><br>
